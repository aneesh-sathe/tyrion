...
- for exceptional exposure only, the pinned Docker CLI and content-addressed effect image, the adapter, and the fixed 2-vCPU, 6144-MiB, 4096-MiB, 256-process profile.
