...
- Acceptance and Assignment readiness commit before the Worker dispatches. The acceptance response exposes that ready state; execution begins only after the response is written.
